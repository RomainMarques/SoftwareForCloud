...
class Book extends Component {
    ...
    deleteBook() {
        axios.post(`http://localhost:3000/server/deletebook`, {owner: localStorage.getItem("email"), title: this.props.title})
        .then((res) => {
    ...
    addBookFromRecco() {
        ...
        axios.post(`http://localhost:3000/server/deleterecco`, {
