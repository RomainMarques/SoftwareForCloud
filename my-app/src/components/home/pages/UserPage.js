...
class UserPage extends Component {
    ...
    getUserInfos() { // récupérer les infos de l'utilisateur
        axios.get(`http://localhost:3000/server/getuser/` + localStorage.getItem("email"))
        .then((res) => {
    ...
    updateUser() { // update les infos de l'utilisateur
        ...
        axios.put(`http://localhost:3000/server/updateuser/` + localStorage.getItem("email"), this.state.newuser)
        .then((res) => {
    ...
    deleteUser() { // supprimer l'utilisateur
        axios.delete(`http://localhost:3000/server/deleteuser/` + localStorage.getItem("email"))
        .then((res) => {
